...
public class mypageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        mypageController.ExcelIO ex = new mypageController.ExcelIO();
        ex.fileRead();
        ...
        try{
            ...
            if(reviewList != null)
                reviewList.getChildren().add(vBox);
